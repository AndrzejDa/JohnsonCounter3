...
HD_PWD='D:/XilinxProjekty/JohnsonCounter3/JohnsonCounter3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log JohnsonCounter3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source JohnsonCounter3.tcl -notrace
